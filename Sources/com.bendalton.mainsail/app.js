...
function connected(jsn) {
    ...
    $SD.on('com.bendalton.mainsail.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.bendalton.mainsail.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.bendalton.mainsail.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.bendalton.mainsail.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.bendalton.mainsail.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.bendalton.mainsail.action.propertyInspectorDidDisappear', (jsonObj) => {
