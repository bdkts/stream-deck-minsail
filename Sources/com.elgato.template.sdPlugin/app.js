...
function connected(jsn) {
    ...
    $SD.on('com.bendalton.mainail.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.bendalton.mainail.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.bendalton.mainail.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.bendalton.mainail.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.bendalton.mainail.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.bendalton.mainail.action.propertyInspectorDidDisappear', (jsonObj) => {
